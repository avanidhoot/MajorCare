        ...
        if(firebaseUser==null) //Loggout state
        {
           ...
           currentuser.once('value',function(snapshot){
                snapshot.forEach(function(childSnapshot){
                    row.push(new Array(i+1,childSnapshot.val().eventName,childSnapshot.val().eventLocation,childSnapshot.val().eventCrowdNumber,childSnapshot.val().eventDate+" "+childSnapshot.val().eventMonth))
